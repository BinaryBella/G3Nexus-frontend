...
interface RequirementStatusDropdownProps {
...
const RequirementStatusBadge = ({ status }: { status: string | number }) => {
...
const RequirementStatusDropdown = ({ requirementId, currentStatus, canManage, onStatusUpdate }: RequirementStatusDropdownProps) => {
    ...
    const updateStatusMutation = useMutation({
        mutationFn: async (newStatus: string) => {
            return await requirementService.updateRequirementStatus(requirementId, newStatus);
        },
        onSuccess: () => {
            // Invalidate and refetch requirements data
    ...
    if (!canManage) {
        return <RequirementStatusBadge status={currentStatus} />;
    }
    ...
    return (
        <div className="relative">
            ...
            >
                <RequirementStatusBadge status={currentStatus} />
