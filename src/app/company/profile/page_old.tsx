    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                if (user && user.email) {
                    try {
                        // Get employee by email using the employee service
                        ...
                        if (currentEmployee) {
                            const profile: ProfileFormData = {
                                ...
                                image: currentEmployee.profileImageUrl || ''
                            };
                            
                            setProfileData(profile);
                            setPreviewImage(profile.image || null);
                        } else {
                            // Fallback to auth context data if employee not found
                            const profile: ProfileFormData = {
                                name: '',
                                contactNo: '',
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="text-black w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3450A3] focus:border-transparent transition-colors"
                                                    required
