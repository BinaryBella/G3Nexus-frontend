...
const EditBugForm = () => {
    ...
    const bugId = parseInt(params.id as string, 10);
    ...
    // Update form state when bug data is loaded
    useEffect(() => {
        const loadClientData = async () => {
            if (bug) {
                const client = await clientService.getClientById(bug.clientId);
                const clientProjects = await projectService.getProjectsByClient(client.email);
                const selectedProject = clientProjects.find(p => p.projectId === bug.projectId);
                ...
                setAttachment(bug.attachment || '');
                setIsActive(bug.isActive ?? true);
            }
        };
    ...
    // Mutation for updating bug
    const updateBugMutation = useMutation({
        mutationFn: (data: Bug) => {
            data.bugId = bugId;
            return bugService.updateBug(data);
        },
        onSuccess: () => {
            setModalMessage('Bug updated successfully!');
            setIsModalOpen(true);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!bugTitle || !severity || !bugDescription || bug?.clientId === null || !project) {
        ...
        try {
            ...
            await updateBugMutation.mutateAsync(updatedBug);
            setTimeout(() => {
    ...
    const closeModal = () => {
        ...
        if (modalMessage.startsWith('Bug updated successfully')) {
            router.push('/company/bugs'); // Redirect after successful update
        }
    };
        ...
        return (
            <div className="flex justify-center items-center min-h-[400px]">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-600">Loading bug...</p>
                </div>
            </div>
        );
    }
    ...
    if (bugError) {
        return (
            <div className="flex justify-center items-center min-h-[400px]">
                <div className="text-center">
                    <p className="text-red-600">Error loading bug. Please try again.</p>
                    <button
                        onClick={() => router.push('/company/bugs')}
        ...
        return (
            <div className="flex justify-center items-center min-h-[400px]">
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Bug Updated Successfully!</h3>
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Update bug information</p>
                    </div>
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className='flex items-center space-x-3'>
                                            ...
                                            <p className="text-xs text-red-600">
                                                File will be permanently deleted when you update the bug
                                            </p>
                                            </div>                                            
                                        </div>
                                        <div className="flex items-center space-x-2">                                        
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                Inactive bugs will be hidden from most views
                            </p>
                        </div>
                        ...
                        <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button
                                ...
                                type="submit"
                                disabled={isSubmitting || updateBugMutation.isPending || isUploading}
                            >
                                {isSubmitting || updateBugMutation.isPending ? 'Updating...' : 'Update Bug'}
                            </button>
                        </div>
                    </form>
                </div>
