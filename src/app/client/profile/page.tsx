    ...
    const handleProfileSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response) {
                ...
                try {
                    const updatedClient = await clientService.getClientByEmail(user?.email || '');
                    if (updatedClient) {
                        const updatedProfile: ProfileFormData = {
                            name: updatedClient.name || '',
                            contactNo: updatedClient.contactNo || '',
                            emailAddress: updatedClient.email || '',
                            address: updatedClient.address || '',
                            image: updatedClient.profileImageUrl || ''
                        };
